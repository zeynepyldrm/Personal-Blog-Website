...
if ($method == 'GET'){
    $sql="";
    $header=$_GET['searchTxt']; // header alanına göre filtereleme
    $sql="select * from Post where Header LIKE '%$header%'";
    //header ("Location:https://bim457.online/19090700029/BlogProject/forms/adminPage.php?searchTxt=".$);
 }
...
if ($result->num_rows > 0) {
    ...
    echo '
    <section class="blog-list px-3 py-5 p-md-5 style="
