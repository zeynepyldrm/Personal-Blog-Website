			...
			<div id="navigation" class="collapse navbar-collapse flex-column" >
				...
				<ul class="navbar-nav flex-column text-left">
					<li class="nav-item active">
					    <a class="nav-link" href="index.html"><i class="fas fa-home fa-fw mr-2"></i>Blog Anasayfa <span class="sr-only">(current)</span></a>
					</li>
					<li class="nav-item">
					    <a class="nav-link" href="#"><i class="fas fa-bookmark fa-fw mr-2"></i>Yayınlananlar</a>
					</li>
					<li class="nav-item">
				...
				<div class="my-2 my-md-3">
				    <a class="btn btn-primary" href="./forms/sign.html" target="_blank">Kayıt Ol</a>
				</div>
			</div>
		</nav>
    </header>
